...
//alert(id)
    ...
    var selectedEventNos = []; // 빈 배열 선언해서 여기에 회원번호를 넣어준다
...
//                            alert('select id : '+ id);
            ...
            if (selectedRows.length > 0)
            {
                ...
                // selectedEventNos를 전역변수(배열)로 선언해서 여기서 데이터 넣어준다
                for (i = 0; i < this.selectedRows.length; i++)
                {
                    ...
                    selectedEventNos = this.selectedRows;
                    
                    console.log(selectedEventNos);
                }
                //console.log(selectedEventNos)
    ...
    $(document).on('click', '#addEvent', function() {
    	top.location.href = 'eventManageWrite.board';
    });
    
    $(document).on('click', '#modifyEvent', function() {
    	if(selectedEventNos.length > 1) {
    		alert('한개의 이벤트만 선택하세요.');
    	} else if(selectedEventNos.length == 0) {
    		alert('수정할 이벤트 한 개를 선택하세요.');
    	} else {
//    		alert('수정 창 띄우기 : ' + selectedEventNos[0]);
    		
    		top.location.href = 'eventManageModify.board?no='+selectedEventNos[0];
    	}
    });
...
//    		alert('삭제 하기');
    		...
    		top.location.href = 'eventManageDelete_ok.board?no='+selectedEventNos[0];
    	}
    });
