...
$(document).ready(function() {
	...
	$(document).on('click', '#a_qnaBoardView_Delete', function() {
		
		qnaBoardDeleteFromDB();
		
	});

	var qnaBoardDeleteFromDB = function() {
		
		var memNo = $('#str_loggedMemNo').val();
		var seq = '';
		seq = $('input[name="seq"]').val();
		
//		alert('123123 : ' + content.indexOf('\n'));
//		alert('123123 : ' + content.indexOf('br'));
//		alert('123123 : ' + content.indexOf('<br>'));
//		alert(content);
...
//			alert(seq + ' ' + memNo);
	...
	//로그인 여부 확인
	$('#a_qnaBoardView_Write').click(function(){
