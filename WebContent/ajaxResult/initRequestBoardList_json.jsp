<%@ page language="java" contentType="text/plain; charset=UTF-8"
    ...
    <%
    	...
    	BoardListTO boardListTO = (BoardListTO)request.getAttribute("requestBoardList");
    	...
    	ArrayList<RequestBoardTO> requestBoardList =  boardListTO.getRequestBoardList();
    	...
    	for(RequestBoardTO to : requestBoardList){
    		result.append(",{");
       		...
       		result.append("\"requestImgName\":\"" + to.getRequestImgName() + "\",");
