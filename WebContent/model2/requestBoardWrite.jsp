...
<!-- 	<td bgcolor='#ffffff' style='padding:20'>  없으면 투명 있으면 하얀 박스--> 
		<form action='requestBoardWrite_ok.board' method='post' name='wfrm' onSubmit='return ChkForm(this)' enctype = "multipart/form-data">
		<%
...
<!-- 				style="color: black" 추가 해줘야 글자가 검은색으로 나옴...ㄷㄷ -->
		...
		<tr>
			...
			<td>
				<input type='file' name='requestImgName' size='50' maxlength='45'>
			</td>
		</tr>
		<tr>
			<td colspan='2' class='imgline'></td>
