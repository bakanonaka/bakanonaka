					...
					<div class="page-mainbar login">
						...
						<div class="login-content">
							...
							<ul id="mytab" class="nav nav-tabs nav-justify">
								<li class="active">
									<a href="#modify" class="br-red" data-toggle="tab">
										<!-- Icon -->
							...
							<div class="tab-content">								
								...
								<div class="tab-pane fade in active br-green" id="modify">
									<!-- Heading -->
									<h2>회원정보수정</h2>
									<!-- Sign Up Form Start -->
									<form class="form-horizontal" role="form" method="post" id = "modifyForm">
										<div class="form-group">
											<div class="col-sm-9">
												<input type="text" class="form-control" id="id" placeholder="아이디" value=""	readonly="readonly">												
											</div>
											<div class="col-sm-3">											
												<a id = "byebyeButton" class="btn btn-black" style="color:black; background:#f55;">회원 탈퇴</a>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-9">
										...
										<div class="form-group">
											<div class="col-sm-9">
												<input type="password" class="form-control" id="confirmpassword" placeholder="비밀번호확인">
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-9">
											...
											<div class="col-sm-3">
												<a id = "namecheckModify" class="btn btn-black">중복 확인</a>
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-9">
												<input type="email" class="form-control" id="email" placeholder="이메일주소" value="" readonly="readonly">
											</div>
										</div>
										<div class="form-group">
											<div class="col-sm-12">
												<div class="" align="right">
													<label>
														<p>쿠폰 및 할인정보 메일 수신</p>
															<input type="radio" id="receivemailflagAgree" name="receivemailflag" value="1"> 동의 &nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" id="receivemailflagDisagree" name="receivemailflag" value="0"> 동의하지않음
										...
										<div class="form-group">
											...
											<div class="" align="right">
													<label>
														<p>선호 색상 선택</p>
															<input type="radio" id = "modify_likeColorflag_select" class = "modify_likeColorflag" name = "modify_likeColorflag" value="1" > 선택 &nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" id = "modify_likeColorflag_none" class = "modify_likeColorflag" name = "modify_likeColorflag" value="0" > 선택하지 않음
														<br/>	
														<!-- 	선택한 컬러 칸 -->
<!-- 														<div id = "modify_SelectedColor" style="border-radius: 2px; margin: 0 auto; border: 0.5px solid white; width: 25%; min-width: 50px; height: 50px; background-color: black;"> -->
<!-- 														</div> -->
													</label>
													<br />
													<label id = "modify_seosonRidioLabel">
														<p>계절 별 색상 보기&nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" id="modify_selectSeasonflag_spring" class = "modify_selectSeasonflag" name = "modify_selectSeasonflag" value="spring" > 봄 &nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" id="modify_selectSeasonflag_summer" class = "modify_selectSeasonflag" name = "modify_selectSeasonflag" value="summer" > 여름 &nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" id="modify_selectSeasonflag_fall" class = "modify_selectSeasonflag" name = "modify_selectSeasonflag" value="fall" > 가을 &nbsp;&nbsp;&nbsp;&nbsp;
															<input type="radio" id="modify_selectSeasonflag_winter" class = "modify_selectSeasonflag" name = "modify_selectSeasonflag" value="winter" > 겨울
														</p>
													</label>
												
													<!-- 셀렉터 -->
													<div id = "modify_selectorList" style="width: 100%; text-align:center;">
														<div id = "modify_spring" style="float:left; width:100%;">
															<select id="modify_colorselector_1">
														...
														<div id = "modify_summer" style="float:left; width:100%;">
															 <select id="modify_colorselector_2">
																<option value="0" data-color="#000000" data-season = "">#000000</option>
														...
														<div id = "modify_fall" style="float:left; width:100%;">
															 <select id="modify_colorselector_3">
																<option value="0" data-color="#000000" data-season = "">#000000</option>
														...
														<div id = "modify_winter" style="float:left; width:100%;">
															<select id="modify_colorselector_4">
																<option value="0" data-color="#000000" data-season = "">#000000</option>
...
<!-- 													<input type="text" id="modify_colorValue" value = "0"/><br />  -->
<!-- 													<input type="text" id="modify_colorColor" value = ""/><br /> -->
<!-- 													<input type="text" id="modify_colorTitle" value = ""/> <br /> -->
<!-- 													<input type="text" id="modify_colorSeason" value = ""/> <br /> -->
													<input type="text" id="modify_colorValue" style = "display: none;" value = "0"/><br /> 
													<input type="text" id="modify_colorColor" style = "display: none;" value = ""/><br />
													<input type="text" id="modify_colorTitle" style = "display: none;" value = ""/> <br />
													<input type="text" id="modify_colorSeason" style = "display: none;" value = ""/> <br />
										...
										<div class="form-group text-center">
											<div class="col-sm-12">
												...
												<a id = "a_modifyUpModal_modify" class="btn btn-black">수정완료</a>									
											</div>
										</div>
									</form>
...
<!-- byebyeModal -->
<div class="modal fade" id="byebyeModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
					...
					<div class="page-mainbar login">
						...
						<div class="login-content">
							...
							<div class="tab-content">								
								...
								<!-- Second Content for Nav bar -->
								<div class="tab-pane fade in active br-brown" id="byebye">
									<!-- Heading -->
									<h2>회원 탈퇴</h2>
									<!-- Sign Up Form Start -->
									<form class="form-horizontal" role="form" method="post" id = "byebyeForm">
										...
										<div class="form-group">
											<div class="col-sm-12">
												<input type="text" class="form-control" id="why" placeholder="탈퇴 사유를 적어주세요">
											</div>
										</div>
										...
										<div class="form-group text-center">
											<div class="col-sm-12">
												...
												<a id = "a_byebyeModal_byebye" class="btn btn-black" align="center" style="font-style:oblique; font-weight:bold; font-size: medium; color:black; background:#f45;">(주의)
												탈퇴 버튼을 누르시면 회원님의 정보가 <br> 완전히 삭제됩니다.</a>									
											</div>
										</div>
									</form>
